...
const listUsers = async () => {
  try {
    const response = await fetch(
      "https://backend-homeservice-573uolvsp-yurani-castellanos-projects.vercel.app/prestador-servicio/listar"
    );
...
const editUser = async (userId, nombres, apellidos, tipoServicio, telefono) => {
  ...
  fetch("https://backend-homeservice-573uolvsp-yurani-castellanos-projects.vercel.app/categoria-servicio/actualizar", {
    method: "PUT",
    body: JSON.stringify({
      userId,
      nombres,
...
const deleteUser = async (idUser) => {
  console.log(idUser);
  fetch(`https://backend-homeservice-573uolvsp-yurani-castellanos-projects.vercel.app/prestador-servicio/eliminar/${idUser}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
...
//     fetch(`https://backend-homeservice-573uolvsp-yurani-castellanos-projects.vercel.app/categoria-servicio/eliminar/${id}`, {
//       method: "DELETE",
//       // Puedes enviar datos al backend si es necesario
//       body: JSON.stringify({}),
//       headers: {
